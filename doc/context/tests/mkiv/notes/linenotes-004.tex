...
\startitemize
\item \type{\textstyle}. How do I style the footnote numerals separate from the text style? \type{style=} covers both. Eg., footnote numerals bold, text in smallcaps.
\item \type{\setuplinenote [linenote] [numbercommand=\low]} compiles, but there is no effect.
